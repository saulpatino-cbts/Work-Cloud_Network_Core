...
> Cuts pod requests without blowing up the service, and keeps nodes busy without keeping pods waiting.
...
[`agents/kubernetes-workload-optimizer.md`](../../agents/kubernetes-workload-optimizer.md). That file is the single source of truth —
...
```
Agent tool → subagent_type: kubernetes-workload-optimizer
```
...
- **Agent:** [`kubernetes-workload-optimizer`](../../agents/kubernetes-workload-optimizer.md)
