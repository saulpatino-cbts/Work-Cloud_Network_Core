...
> One cost dataset to rule them all.
...
[`agents/cost-warehouse-modeler.md`](../../agents/cost-warehouse-modeler.md). That file is the single source of truth —
...
```
Agent tool → subagent_type: cost-warehouse-modeler
```
...
- **Agent:** [`cost-warehouse-modeler`](../../agents/cost-warehouse-modeler.md)
